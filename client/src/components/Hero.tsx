...
export default function Hero() {
    ...
    const mainImageUrl = "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=1600&auto=format&fit=crop";



    const galleryStripImages = [
  'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=100',
  'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?q=80&w=100',
  'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=100',
];
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Create Your Own Ads And Videos <br />
                            ...
                            >
                                Upload Product Images and A person Picture - Spectra Will Instantly Generate a Short-Video from it - Can Be Used For Commercials & Reels.
                            </motion.p>
